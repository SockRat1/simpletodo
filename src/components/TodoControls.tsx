...
function TodoControls({ onReset, onClear }: TypeProps) {
  return (
    <div className={styles.controls}>
      <TodoButton onClick={onReset}>
        <svg width="800px" height="800px" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg" className={styles.svg}>
