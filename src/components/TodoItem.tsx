...
function TodoItem({ text, isChecked, toggleTodo, deleteTodo }: TypeProps) {
  return (
    <div className={styles.item + " " + (isChecked && styles.checked)}>
      <p className={styles.text + " " + (isChecked && styles.strike)}>{text}</p>
      <div className={styles.buttons}>
        <TodoButton onClick={deleteTodo}>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 128 128" className={styles.svg}>
        ...
        <TodoButton onClick={toggleTodo}>
          <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 26 26" className={styles.svg}>
